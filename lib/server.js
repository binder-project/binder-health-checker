 ...
 */
BinderHealthChecker.prototype._getAllBuilds = function (api) {
  if (!this.buildInfo) {
 ...
 */
BinderHealthChecker.prototype._getBuild = function (api) {
  var self = this
  if (!this.buildInfo) {
    return api._noBuildInfo()
  }
 ...
 */
BinderHealthChecker.prototype._startBuild = function (api) {
  var self = this
  if (!this.buildInfo) {
    return api._noBuildInfo()
  }
...
BinderHealthChecker.prototype._fetchTemplate = function (api) {
  var self = this
...
BinderHealthChecker.prototype._fetchAllTemplates = function (api) {
  var self = this
